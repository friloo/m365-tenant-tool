...
<div class="alert alert-light border d-flex align-items-start gap-2 mb-4">
  ...
  <div class="small">
    Hier liegen deine angepinnten Seiten. Öffne ein beliebiges Modul und tippe oben rechts auf
    den <i class="bi bi-star"></i>-Stern, um es zu den Favoriten hinzuzufügen. Die Favoriten
    werden lokal in diesem Browser gespeichert.
  </div>
</div>
