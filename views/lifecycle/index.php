...
<div class="alert alert-info d-flex gap-3 mb-3">
    ...
    <div>
        <strong>Lifecycle Workflows</strong> automatisieren Joiner/Mover/Leaver-Prozesse — z. B. „bei
        neuem Mitarbeiter automatisch in die Standard-Gruppen aufnehmen, Welcome-Mail senden,
        Manager benachrichtigen" oder „bei Austritt Konto deaktivieren, Lizenzen entfernen, 30 Tage
        warten, dann löschen". Lizenz-Voraussetzung: <strong>Microsoft Entra ID Governance</strong>.
    </div>
</div>
    ...
    <div class="card-body-custom p-0">
        <?php if (empty($workflows)): ?>
            <div class="text-muted small p-4 text-center">
                Keine Lifecycle-Workflows definiert. Konfiguration unter
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <span class="text-muted small">manuell</span>
                                <?php endif; ?>
                            </td>
                            ...
                            <td class="text-muted small">
                                <?php if ($last): ?>
                                    ...
                                    <div>Status: <?= $e($last['processingStatus'] ?? '–') ?></div>
                                <?php else: ?>—<?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
