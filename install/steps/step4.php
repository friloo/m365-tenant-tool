...
<form method="post" action="?step=4">
    <div class="mb-3">
        <label class="form-label fw-semibold">Anwendungsname</label>
        <input type="text" name="app_name" class="form-control" value="M365 Tenant Tool" required>
        <div class="form-text">Wird im Browser-Tab und in E-Mails verwendet.</div>
    </div>

    <div class="mb-3">
        <label class="form-label fw-semibold">Öffentliche URL des Tools</label>
        <input type="url" name="app_base_url" class="form-control"
               placeholder="https://m365.firma.de"
               value="<?= htmlspecialchars($_SESSION['install_settings']['appBaseUrl'] ?? '') ?>">
        <div class="form-text">
            Wird für den Bestätigungslink im Freigaben-Monitor verwendet
            (z.B. <code>https://m365.firma.de/review/…</code>). Ohne Trailing-Slash.
        </div>
    </div>

    <div class="row g-3 mb-3">
        <div class="col-6">
            <label class="form-label fw-semibold">Cache-Dauer</label>
        ...
        <div class="col-6">
            <label class="form-label fw-semibold">Zeitzone</label>
