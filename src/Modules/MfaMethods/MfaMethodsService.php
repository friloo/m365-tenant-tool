...
class MfaMethodsService
{
    ...
    {
        return [
            'microsoftAuthenticatorPush'         => t('Microsoft Authenticator (Push)'),
            'microsoftAuthenticatorPasswordless' => t('Microsoft Authenticator (Passwordless)'),
            'softwareOneTimePasscode'            => t('Authenticator App (TOTP)'),
            'hardwareOneTimePasscode'            => t('Hardware-Token (TOTP)'),
            'phoneAuthentication'                => t('SMS / Anruf'),
            'mobilePhone'                        => t('SMS / Anruf (Mobil)'),
            'alternateMobilePhone'               => t('SMS / Anruf (Alt. Mobil)'),
            'officePhone'                        => t('Bürotelefon'),
            'voiceCall'                          => t('Sprachanruf'),
            'fido2SecurityKey'                   => t('FIDO2-Sicherheitsschlüssel'),
            'passKey'                            => t('Passkey'),
            'passKeyDeviceBound'                 => t('Passkey (gerätegebunden)'),
            'windowsHelloForBusiness'            => t('Windows Hello'),
            'email'                              => t('E-Mail OTP'),
            'temporaryAccessPass'                => t('Temporärer Zugangscode'),
            'securityQuestion'                   => t('Sicherheitsfrage'),
            'appNotification'                    => t('App-Benachrichtigung'),
            'appCode'                            => t('App-Code'),
            'appPassword'                        => t('App-Passwort'),
        ];
    }
